...
class ArmController:
    ...
    def UpdateData(self)->None:
        self.q = self.franka.get_joint_positions()[:7].T
        self.qd = self.franka.get_joint_velocities()[:7].T
        self.torque = self.franka.get_applied_joint_efforts()[:7].T
    ...
    def write(self)->None:
        self.franka.set_joint_positions(positions=np.concatenate((self.q_desired, np.zeros(2)), axis=0))
